...
*/
async function transfer(urlNode, addressSC, balance, tokenId, walletJson, password, abi, fromId, toId) {
    ...
    try {
        return contractWithSigner.transfer(fromId, toId, balance, tokenId, overrides);
    } catch (error) {
